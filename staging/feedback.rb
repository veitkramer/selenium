...
class LogIn < Test::Unit::TestCase
  ...
  def test_feedback
    ...
    @driver.get "https://staging.shore.com/merchant/app/feedback"

    sleep 3

    verify { assert_include @driver.find_element(:css, "#yield").text, "KUNDE" }

    verify { assert_include @driver.find_element(:css, "#yield").text, "Woods" }
    ...
    checkbox = @driver.find_element(:css, "tbody.mtw-rows > tr:nth-of-type(1) > td.mtw-public > div.checkbox.checkbox-slider.checkbox-slider--b-flat > label > span");
      ...
      verify { assert_include @driver.find_element(:css, "#feedback > li:nth-child(1) > div > div.comment").text, "Best service ever"}
