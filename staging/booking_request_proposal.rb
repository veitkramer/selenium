...
class LogIn < Test::Unit::TestCase
  ...
  def test_booking_request_proposal
...
#book appointment
    ...
    sleep 5
    @driver.find_element(:css, "div.jspPane > div:nth-of-type(6) > div:nth-of-type(1)").click
    sleep 1
    ...
    sleep 1
    @driver.find_element(:css, "input#first-name.ember-view.ember-text-field.form-control").send_keys "Emerson"
    @driver.find_element(:css, "input#last-name.ember-view.ember-text-field.form-control").send_keys "Fitipaldy"
    @driver.find_element(:css, "input#email.ember-view.ember-text-field.form-control").send_keys "js+eme@shore.com"
    @driver.find_element(:css, "input#mobile.ember-view.ember-text-field.phonable.form-control").send_keys "44444444444"
