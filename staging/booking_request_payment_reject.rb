...
class LogIn < Test::Unit::TestCase
  ...
  def test_booking_request_payment_reject
...
#check bookingrules if request is enable or not
  ...
  #book appointment with payment
        ...
        @driver.find_element(:css, "input#last-name.ember-view.ember-text-field.form-control").send_keys "Torres"
        @driver.find_element(:css, "input#email.ember-view.ember-text-field.form-control").send_keys "js+serg@shore.com"
        @driver.find_element(:css, "input#mobile.ember-view.ember-text-field.phonable.form-control").send_keys "6666666666666"
