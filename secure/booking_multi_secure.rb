...
#book appointment
        ...
        sleep 1
        @driver.find_element(:css, "div.item-group.expanded > div:nth-of-type(2) > div.item-content > div.item-content-left > div.item-name").click
        sleep 1
        @driver.find_element(:css, "div.item-group.expanded > div:nth-of-type(3) > div.item-content > div.item-content-left > div.item-name").click
        sleep 2
        ...
        verify { assert_include @driver.find_element(:css, "div.total-row.flex-row > div.total-row-price.flex-cell.text-right").text, "70,50" }
        @driver.find_element(:css, "div.items > div:nth-of-type(1) > div.item-content.with-icons > div.item-content-left").click
        sleep 1
