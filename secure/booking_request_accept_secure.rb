...
#book appointment
        ...
        sleep 1
        @driver.find_element(:css, "input#first-name.ember-view.ember-text-field.form-control").send_keys "Bubba"
        @driver.find_element(:css, "input#last-name.ember-view.ember-text-field.form-control").send_keys "Watson"
        @driver.find_element(:css, "input#email.ember-view.ember-text-field.form-control").send_keys "js+bw@shore.com"
        ...
        sleep 5
        @driver.find_element(:css, "div.actions-template > button.btn.btn-primary").click
