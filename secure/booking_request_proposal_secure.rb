...
#book appointment
        ...
        sleep 5
        @driver.find_element(:css, "div.actions-template > button:nth-of-type(1)").click
        sleep 5
        @driver.find_element(:css, "div.row.tab-like-container > div:nth-of-type(1) > div.input-group.input-group-datetime > input.form-control.ui-timepicker-input").clear
        @driver.find_element(:css, "div.row.tab-like-container > div:nth-of-type(1) > div.input-group.input-group-datetime > input.form-control.ui-timepicker-input").send_keys "19:00"
