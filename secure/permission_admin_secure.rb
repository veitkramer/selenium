...
#checking if all apps are present
  ...
  #Mitarbeiter
    ...
    sleep 5
    @driver.find_element(:css, "tbody.mtw-rows > tr:nth-of-type(1) > td:nth-of-type(7) > div.mtw-column-actions > span.mtw-column-action-delete-row")
    sleep 3
  ...
  #Web-Baukasten
    ...
    sleep 1
  #Filiale
    verify { assert_include @driver.find_element(:css, "[href=\"#/location\"]").text, "Filiale" }
    sleep 1
  #Messenger
