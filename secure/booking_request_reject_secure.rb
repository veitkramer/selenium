...
class LogIn < Test::Unit::TestCase
  ...
  def setup
    ...
    @base_url = "https://connect.shore.com/widget/testmerchant-qa"
  ...
  def test_booking_accept_secure
#check bookingrules if request is enable or not
        ...
        sleep 3
        @driver.get "https://my.shore.com/calendar/week#/location"
        sleep 3
...
#book appointment
        ...
        @driver.find_element(:css, "input#last-name.ember-view.ember-text-field.form-control").send_keys "Duffner"
        @driver.find_element(:css, "input#email.ember-view.ember-text-field.form-control").send_keys "js+dd@shore.com"
        ...
        sleep 3
        verify { assert_include @driver.find_element(:css, "h5.status-headline").text, "Ihre Terminanfrage wurde übermittelt." }

        @driver.get "https://my.shore.com/calendar/week"
        sleep 5
        @driver.find_element(:css, "i.shore-icon-backend-nav-appointments").click
        ...
        sleep 3
        verify { assert_include @driver.find_element(:css, "h5.status-headline").text, "Ihre Terminanfrage wurde abgelehnt." }
