...
class LogIn < Test::Unit::TestCase
  ...
  def test_booking_payment_validation_appshell
...
#book appointment with payment
        ...
        sleep 1
        @driver.find_element(:css, "input#first-name.ember-view.ember-text-field.form-control").send_keys "Dave"
        @driver.find_element(:css, "input#last-name.ember-view.ember-text-field.form-control").send_keys "Abigayle"
        @driver.find_element(:css, "input#email.ember-view.ember-text-field.form-control").send_keys "js+dave@shore.com"
        @driver.find_element(:css, "input#mobile.ember-view.ember-text-field.phonable.form-control").send_keys "66666666666"
        ...
        #verify ccard number
        verify { assert_include @driver.find_element(:css, "div.summary-section-content.form-container > div:nth-of-type(2) > div.row > div.col > div.has-error > p.help-block").text, "Pflichtfeld" }
        #verify ccard owner
        verify { assert_include @driver.find_element(:css, "div.summary-section-content.form-container > div:nth-of-type(3) > div.row > div.col > div.has-error > p.help-block").text, "Pflichtfeld" }
        #verify ccard good thru month
        verify { assert_include @driver.find_element(:css, "div.summary-section-content.form-container > div:nth-of-type(4) > div.row > div:nth-of-type(1) > div.has-error > p.help-block").text, "Pflichtfeld" }
        #verify ccard good thru year
        verify { assert_include @driver.find_element(:css, "div.row > div:nth-of-type(2) > div.has-error > p.help-block").text, "Pflichtfeld" }
        #verifx CVC
        verify { assert_include @driver.find_element(:css, "div.row > div:nth-of-type(3) > div.has-error > p.help-block").text, "Pflichtfeld" }
