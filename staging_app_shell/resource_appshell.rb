...
#create table
    @driver.get "https://staging.shore.com/merchant/resources?appshell=true&merchant_profile_id=98a23f30-7a65-4605-aea7-b81c56f8e027"
    sleep 3
...
#edit ressource
    ...
    #sleep 1
    @driver.find_element(:css, "div#resources div:nth-child(1) > a > div").click
    sleep 2
    @driver.find_element(:id, "resource_name").clear
    sleep 1
...
#delete resource
    sleep 3
    element = @driver.find_element(:css, "div#resources div:nth-child(1) > a > div")
    sleep 1
    @driver.action.move_to(element).perform
    sleep 1
