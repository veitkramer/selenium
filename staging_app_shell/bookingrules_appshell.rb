...
class LogIn < Test::Unit::TestCase
  ...
  def test_bookingrules_appshell
...
#check person count
            ...
            @driver.get "https://staging-connect.shore.com/widget/endeavourdude"
            sleep 4
...
#change sender id sms and email
    ...
    sleep 2
    verify { assert_equal "Termin mit Arbeitsschritten", @driver.find_element(:css, "ul.nav.nav-tabs > li:nth-of-type(2) > button").text }
    sleep 3
